...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Criação de despesas
        yield prisma.expenses.createMany({
            data: [
        ...
        yield prisma.salesSummary.createMany({
            data: [
        ...
        yield prisma.purchaseSummary.createMany({
            data: [
        ...
        yield prisma.expenseSummary.createMany({
            data: [
        ...
        yield prisma.expenseByCategory.createMany({
            data: [
                {
                    expenseSummaryId: 1,
